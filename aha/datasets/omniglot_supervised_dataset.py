...
"""OmniglotSupervisedDataset class."""
...
class OmniglotSupervisedDataset(OmniglotDataset):
  """Omniglot Supervised Dataset based on tf.data."""

  def __init__(self, directory):
    super(OmniglotSupervisedDataset, self).__init__(directory=directory)
  ...
  def get_train(self, preprocess=False):
    ...
    return self._dataset(self._directory, 'images_evaluation_supervised/train')

  def get_test(self, preprocess=False):
    """tf.data.Dataset object for Omniglot test data."""
    return self._dataset(self._directory, 'images_evaluation_supervised/test')
